...
let mapleader = ' '
nmap <s-space> <leader>
autocmd BufWinEnter *.py nnoremap <buffer> <F5> <leader>w:!py main.py<ENTER>
autocmd BufWinEnter *.c,*.cpp,*.h nnoremap <buffer> <F5> <leader>w:!make test<ENTER>
autocmd BufWinEnter *.js,*.css,*.html nnoremap <buffer> <F5> <leader>w:!index.html<ENTER>
